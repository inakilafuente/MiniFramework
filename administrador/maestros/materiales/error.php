...
$tituloErrArriba = strtoupper( (string)$auxiliar->traduce("Error Tipos de Incidencias", $administrador->ID_IDIOMA));
$tituloErr       = "ERROR";

$textoErr == "";
include $pathRaiz . "errores_genericos.php";

if ($TipoError == "CampoExistente"):
    $textoErr = $auxiliar->traduce("Ya existe otro campo igual en la misma pantalla", $administrador->ID_IDIOMA);
elseif ($TipoError == "ErrorIncidenciaSistemaTipoVacio"):
    $textoErr = $auxiliar->traduce("El campo incidencia sistema tipo está vacío", $administrador->ID_IDIOMA);
elseif ($TipoError == "ErrorIncidenciaSistemaTipoEngVacio"):
    $textoErr = $auxiliar->traduce("El campo incidencia sistema tipo Eng. está vacío", $administrador->ID_IDIOMA);
elseif ($TipoError == "ErrorBajaVacio"):
    $textoErr = $auxiliar->traduce("El baja es vacío", $administrador->ID_IDIOMA);
elseif ($TipoError == "ErrorArchivoImportado"):
    $textoErr = $auxiliar->traduce("Error al importar el archivo", $administrador->ID_IDIOMA);
elseif ($TipoError == "TipoArchivoNoXLSX"):
    $textoErr = $auxiliar->traduce("El archivo a importar no tiene extensión XLSX", $administrador->ID_IDIOMA);
