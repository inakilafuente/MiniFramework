...
<FORM NAME="FormSelect" ACTION="ficha_importacion_AGM_excel_paso2.php" METHOD="POST" enctype="multipart/form-data">
    <input type=hidden name="accion" value="importar_material_almacen">
    <input type=hidden name="idMaterial" value="<?=$_GET['idMaterial']?>">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="150" height=20 class=textoazul>
                                                                            <?= $auxiliar->traduce("Archivo a Importar (xlsx)", $administrador->ID_IDIOMA) . ":"; ?>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2" class=textoazul height=20>
                                                                            ...
                                                                            <p><?= $auxiliar->traduce("La primera linea del fichero contiene los titulos. Esta linea no se tendra en cuenta al importar.", $administrador->ID_IDIOMA) ?>
                                                                                ...
                                                                                <br>
                                                                                <br>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <?= $auxiliar->traduce("Cantidad", $administrador->ID_IDIOMA)?>
                                                                                <br>
                                                                                <br>
                                                                            </p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class=textoazul height=20>
                                                                            <p><?= $auxiliar->traduce("Fichero de ejemplo", $administrador->ID_IDIOMA) ?>
                                                                                :</p>
                                                                            <p>
                                                                                <a href="<?= $pathRaiz . "descargarDocumento.php?key=ejemplos&ruta=documentos_app/Linea_excel_AGM.xlsx"; ?>">
                                                                        ...
                                                                        <td class=textoazul height=20>
                                                                            <p><?= $auxiliar->traduce("Plantilla", $administrador->ID_IDIOMA) ?>
                                                                                :</p>
                                                                            <p>
                                                                                <a href="<?= $pathRaiz . "descargarDocumento.php?key=ejemplos&ruta=documentos_app/Linea_excel_AGM_Plantilla.xlsx"; ?>">
