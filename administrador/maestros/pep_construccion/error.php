...
$tituloErrArriba = strtoupper( (string)$auxiliar->traduce("Error PEP Construccion", $administrador->ID_IDIOMA));
$tituloErr       = "ERROR";
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" bgcolor="#FFFFFF"
                            ...
                            <table id="fullheighttable" width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="23">
