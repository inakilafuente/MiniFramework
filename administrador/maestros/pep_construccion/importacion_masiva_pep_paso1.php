...
<FORM NAME="FormSelect" ACTION="importacion_masiva_pep_paso2.php" METHOD="POST" enctype="multipart/form-data">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="150" height=20 class=textoazul>
                                                                            <?= $auxiliar->traduce("Archivo Excel a Importar", $administrador->ID_IDIOMA) ?>
                                                                            :
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2" class=textoazul height=20>
                                                                            ...
                                                                            <p><?= $auxiliar->traduce("Seleccione el archivo Excel a importar y pulse el boton 'Importar' para realizar una validacion previa de la carga", $administrador->ID_IDIOMA) . "." ?>
                                                                            </p>
                                                                            <br/>
                                                                            ...
                                                                            <p><?= $auxiliar->traduce("La primera linea del fichero contiene los titulos. Esta linea no se tendra en cuenta al importar.", $administrador->ID_IDIOMA) ?>
                                                                                ...
                                                                                <br/>
                                                                                - <?= $auxiliar->traduce("Descripcion PEP", $administrador->ID_IDIOMA) ?>
                                                                                <br/>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class=textoazul height=20>
                                                                            ...
                                                                            <p>
                                                                                <a href="<?= $pathRaiz . "descargarDocumento.php?key=ejemplos&ruta=ficheros_ejemplo/PepConstruccion.xlsx"; ?>">
                                                                        ...
                                                                        <td class=textoazul height=20>
                                                                            ...
                                                                            <p>
                                                                                <a href="<?= $pathRaiz . "descargarDocumento.php?key=ejemplos&ruta=ficheros_ejemplo/PepConstruccion_Plantilla.csv"; ?>">
                                                ...
                                                <td align="right" class="lineabajo">
                                                     <span class="textoazul">
                                                         &nbsp;<a href="#" class="senalado6"
                                                                  onClick="document.FormSelect.submit();return false">
