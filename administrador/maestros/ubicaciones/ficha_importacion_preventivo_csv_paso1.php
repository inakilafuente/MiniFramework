...
<FORM NAME="FormSelect" ACTION="ficha_importacion_preventivo_csv_paso2.php" METHOD="POST" enctype="multipart/form-data">
    <input type=hidden name="accion" value="importar_diccionario">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" bgcolor="#FFFFFF"
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr bgcolor="#D9E3EC">
                                    <td height="370" align="center" valign="top" bgcolor="#AACFF9" class="lineabajo">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="150" height=20 class=textoazul>
                                                                            <?= $auxiliar->traduce("Archivo CSV a Importar", $administrador->ID_IDIOMA) ?>
                                                                            :
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2" class=textoazul height=20>
                                                                            ...
                                                                            <p><?= $auxiliar->traduce("Seleccione del equipo un archivo a importar en formato csv (generado a partir de un archivo Excel).", $administrador->ID_IDIOMA) ?>
                                                                                <br/>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class=textoazul height=20>
                                                                            ...
                                                                            <p>
                                                                                <a href="<? echo $pathClases . "documentos/ficheros_ejemplo/UbicacionesPreventivo_Ejemplo.xls"; ?>"
                                                                                   target="_blank"
                                                                                   download><?= $auxiliar->traduce("Ver Excel ejemplo", $administrador->ID_IDIOMA) ?></a>
                                                                            </p>
                                                                        </td>
                                                                        <td class=textoazul height=20>
                                                                            ...
                                                                            <p>
                                                                                <a href="<? echo $pathClases . "documentos/ficheros_ejemplo/UbicacionesPreventivo_Plantilla.csv"; ?>"
                                                                                   target="_blank"
                                                                                   download><?= $auxiliar->traduce("Ver Plantilla", $administrador->ID_IDIOMA) ?></a>
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                </table>
