...
$pathRaiz   = "../../";
$pathClases = "../../../";
$tituloPag  = $auxiliar->traduce("Ajustes de Inventario", $administrador->ID_IDIOMA);
$tituloNav  = $auxiliar->traduce("Almacén", $administrador->ID_IDIOMA) . " >> " . $auxiliar->traduce("Ajustes de Inventario", $administrador->ID_IDIOMA);

$ZonaTablaPadre = "Almacen";
$ZonaTabla      = "AlmacenStockPorUbicacion";

$tituloErrArriba = strtr( (string)strtoupper( (string)$auxiliar->traduce("Error Almacén", $administrador->ID_IDIOMA)), "àèìòùáéíóúçñäëïöü", "ÀÈÌÒÙÁÉÍÓÚÇÑÄËÏÖÜ");
$tituloErr       = "ERROR";

$textoErr == "";
include $pathRaiz . "errores_genericos.php";
if ($TipoError == "AlmacenNoExiste"):
    $textoErr = $auxiliar->traduce("El Almacen no existe", $administrador->ID_IDIOMA);
endif;
