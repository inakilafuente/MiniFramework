...
<FORM NAME="FormSelect" ACTION="ficha_importacion_preventivo_excel_paso2.php" METHOD="POST"
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class=textoazul height=20>
                                                                            ...
                                                                            <p>
                                                                                <a href="<? echo $pathClases . "documentos/ficheros_ejemplo/UbicacionesPreventivo_Ejemplo.xlsx"; ?>"
                                                                                   target="_blank"
                                                                        ...
                                                                        <td class=textoazul height=20>
                                                                            ...
                                                                            <p>
                                                                                <a href="<? echo $pathClases . "documentos/ficheros_ejemplo/UbicacionesPreventivo_Plantilla.xlsx"; ?>"
                                                                                   target="_blank"
