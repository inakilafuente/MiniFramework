...
class Worksheet extends BIFFwriter
  ...
  */
  function __construct($name,$index,&$activesheet,&$firstsheet,&$url_format)
    {
...
*
* @param $margin The margin to set in inches
*/
...
*/
  function write_url($row, $col, $url, $string = '', $format = 0)
    ...
    return($this->write_url_range($row, $col, $row, $col, $url, $string, $format));
    }
...
*/
  function _store_panes($y,$x,$rwTop,$colLeft,$pnnAct)
    {
...
function combinarCeldas($first_row, $first_col, $last_row, $last_col){
...
* MSDN library.
*/
  function _process_bitmap_ori($bitmap)
    {
    // Open file.
