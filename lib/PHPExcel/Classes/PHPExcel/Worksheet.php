...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    /**
     * Clon de setCellValueByColumnAndRow() que codifica el valor a insertar a la celda para evitar fallos por caracteres extraños
     *
     * @param string $pColumn Numeric column coordinate of the cell (A = 0)
     * @param string $pRow Numeric row coordinate of the cell
     * @param mixed $pValue Value of the cell
     ...
     * @return PHPExcel_Worksheet|PHPExcel_Cell    Depending on the last parameter being specified
     */
    public function escribirTexto($pColumn = 0, $pRow = 1, $pValue = null, $returnCell = false)
    {
        // PARA EVITAR FALLOS POR CARACTERES EXTRAÑOS
        $pValue = mb_convert_encoding((string)$pValue, 'UTF-8');
     ...
     * @return PHPExcel_Worksheet
     */
    public function setConditionalStyles($pCoordinate = 'A1', $pValue = null)
    {
